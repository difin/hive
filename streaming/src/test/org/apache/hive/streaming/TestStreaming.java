...
public class TestStreaming {
  ...
  public void testTimeStamp() throws Exception {
    dropTables(driver, "default.timest");
    runQuery(driver, "create table default.timest (a TIMESTAMP) stored as orc "
        + "TBLPROPERTIES('transactional'='true')");
    ...
    for (int i = 0; i < 3; i++){
      Assert.assertEquals("2018-10-19 10:35:00", rs.get(i));
    }
    for (int i = 3; i < rs.size(); i++){
      Assert.assertEquals("2018-10-19 10:35:00.123", rs.get(i));
    }
  }
