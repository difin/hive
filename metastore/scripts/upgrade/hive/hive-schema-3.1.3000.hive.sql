...
CREATE OR REPLACE VIEW `CDH_VERSION` AS SELECT 1 AS `VER_ID`, '3.1.3000.7.2.16.0-Update2' AS `SCHEMA_VERSION`,
  'Hive release version 3.1.3000 for CDH 7.2.16.0-Update2' AS `VERSION_COMMENT`;

SELECT 'Finished initializing schema to 3.1.3000.7.2.16.0-Update2';
