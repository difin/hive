...
SELECT 'Upgrading MetaStore schema from 3.1.3000 to 3.1.3000.7.2.15.0-Update5';

USE SYS;

CREATE OR REPLACE VIEW `CDH_VERSION` AS SELECT 1 AS `VER_ID`, '3.1.3000.7.2.15.0-Update5' AS `SCHEMA_VERSION`,
  'Hive release version 3.1.3000 for CDH 7.2.15.0-Update5' AS `VERSION_COMMENT`;

SELECT 'Finished initializing schema to 3.1.3000.7.2.15.0-Update5';
