...
SELECT 'Upgrading MetaStore schema from 3.1.3000 to 3.1.3000.7.3.2.0-update1';
...
CREATE OR REPLACE VIEW `CDH_VERSION` AS SELECT 1 AS `VER_ID`, '3.1.3000.7.3.2.0-update1' AS `SCHEMA_VERSION`,
  'Hive release version 3.1.3000 for CDH 3.1.3000.7.3.2.0-update1' AS `VERSION_COMMENT`;
