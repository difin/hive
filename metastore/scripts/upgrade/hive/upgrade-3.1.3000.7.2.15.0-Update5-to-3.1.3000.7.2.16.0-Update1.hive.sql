SELECT 'Upgrading MetaStore schema from 3.1.3000.7.2.15.0-Update5 to 3.1.3000.7.2.16.0-Update1';
...
(
  ...
  NULL,
  CC_TBLPROPERTIES
  FROM `sys`.`COMPLETED_COMPACTIONS`
  UNION ALL
  SELECT
  CQ_ID,
  'default',
  ...
  CQ_TBLPROPERTIES
  FROM `sys`.`COMPACTION_QUEUE`;

CREATE OR REPLACE VIEW SYS.CDH_VERSION AS SELECT 1 AS VER_ID, '3.1.3000.7.2.16.0-Update1' AS SCHEMA_VERSION,
                                                 'Hive release version 3.1.3000 for CDH 7.2.16.0-Update1' AS VERSION_COMMENT;

SELECT 'Finished upgrading MetaStore schema from 3.1.3000.7.2.15.0-Update5 to 3.1.3000.7.2.16.0-Update1';