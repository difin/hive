 ...
 *
 * <p>Tests: {@code TestRestCatalogScanPlanning} and {@code RestCatalogScanPlanningServerIT} in
 * {@code iceberg-rest-catalog-client}; {@code TestHiveIcebergServerSideScanPlanning} in
 * {@code iceberg-handler}.
 *
