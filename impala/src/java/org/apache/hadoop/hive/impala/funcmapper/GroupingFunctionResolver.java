...
/**
 * Function resolving for the Impala "grouping" function.
 */
public class GroupingFunctionResolver extends ImpalaFunctionResolverImpl {

  public GroupingFunctionResolver(FunctionHelper helper, SqlOperator op, List<RexNode> inputNodes) {
  ...
  public RelDataType getRetType(ImpalaFunctionSignature function, List<RexNode> operands) {
    return rexBuilder.getTypeFactory().createSqlType(SqlTypeName.BIGINT);
  }
