...
import org.apache.hadoop.hive.impala.expr.ImpalaAnalyticExpr;
...
import org.apache.hadoop.hive.impala.rex.ImpalaRexVisitor.ImpalaProvidedMappingRexVisitor;
...
abstract public class ImpalaProjectRelBase extends ImpalaPlanRel {
  ...
  private AnalyticExpr getAnalyticExpr(RexOver rexOver, ImpalaPlannerContext ctx, ImpalaPlanRel inputRel)
    ...
    Function fn = getFunction(ctx, rexOver);
  ...
  private Function getFunction(ImpalaPlannerContext ctx, RexOver exp)
      throws HiveException {
    ...
    String db = ctx.getQueryContext().getDbName();
    return ImpalaRelUtil.getAggregateFunction(db, aggFunction, retType, operandTypes);
  }
}
