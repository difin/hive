...
public class ImpalaThriftBinaryInspector extends AbstractPrimitiveObjectInspector implements BinaryObjectInspector {

    ImpalaThriftBinaryInspector() {
    ...
    public byte[] getPrimitiveJavaObject(Object o) {
        ...
        return ((String) ImpalaResultInspector.toColumnValue(value)).getBytes();
    }
