...
public class FunctionDetailStatics {
  ...
  public static Map<String, Set<String>> IMPALA_FUNCTION_MAP =
      ...
      .put("casttodate", ImmutableSet.of("cast", "cast_format"))
      ...
      .put("casttostring", ImmutableSet.of("cast", "cast_format"))
      .put("casttotimestamp", ImmutableSet.of("cast", "cast_format"))
      ...
      .put("int_divide", ImmutableSet.of("div", "int_divide"))
