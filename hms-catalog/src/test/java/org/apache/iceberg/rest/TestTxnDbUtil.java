...
public final class TestTxnDbUtil {
  ...
  static public String getTruncateStatement(DatabaseProduct db, String name) {
    if (db.equals(DatabaseProduct.POSTGRES) || db.equals(DatabaseProduct.MYSQL)) {
  ...
  static public String getPrepareTxnStmt(DatabaseProduct db) {
  ...
  public static List<String> getResetTxnSequenceStmts(DatabaseProduct dbType) {
  ...
  public static synchronized void prepDb(Configuration conf) throws Exception {
    ...
    try {
      ...
      DatabaseProduct dbProduct = determineDatabaseProduct(s);
  ...
  private static void resetTxnSequence(DatabaseProduct databaseProduct, Statement stmt) throws SQLException {
    for (String s : getResetTxnSequenceStmts(databaseProduct)) {
      stmt.execute(s);
    }
  }
  ...
  private static boolean truncateTable(Connection conn, Configuration conf, Statement stmt, String name) {
    try {
      ...
      try {
        ...
        String s = getTruncateStatement(databaseProduct, name);
        stmt.execute(s);
  ...
  public static Connection getConnection(Configuration conf) throws Exception {
    ...
    DatabaseProduct dbProduct = determineDatabaseProduct(conn.getMetaData().getDatabaseProductName());
    String initSql = getPrepareTxnStmt(dbProduct);
    if (initSql != null) {
