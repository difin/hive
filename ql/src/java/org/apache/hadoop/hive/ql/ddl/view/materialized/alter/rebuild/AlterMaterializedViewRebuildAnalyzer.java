...
public class AlterMaterializedViewRebuildAnalyzer extends CalcitePlanner {
  ...
  protected Frameworks.PlannerAction<CalcitePlan> createPlannerAction(
    ...
    return new MVRebuildCalcitePlannerAction(generateEnginePlan, partitionCache, colStatsCache, columnAccessInfo);
  }

  protected class MVRebuildCalcitePlannerAction extends CalcitePlannerAction {
    public MVRebuildCalcitePlannerAction(boolean generateEnginePlan,
                                         Map<String, PrunedPartitionList> partitionCache,
                                         Map<String, ColumnStatsList> colStatsCache,
                                         ColumnAccessInfo columnAccessInfo) {
      super(generateEnginePlan, partitionCache, colStatsCache, columnAccessInfo, getQB());
    }
    ...
    protected RelNode applyMaterializedViewRewriting(RelOptPlanner planner, RelNode basePlan,
      ...
      try {
        ...
        materialization = materialization.copyToNewCluster(optCluster, functionHelper.getPartitionPruneRuleHelper());
