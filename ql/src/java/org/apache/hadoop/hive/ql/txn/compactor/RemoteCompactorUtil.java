...
public class RemoteCompactorUtil {
  ...
  public static List<Partition> getPartitionsByNames(HiveConf conf, IMetaStoreClient msc, String dbName, String tableName,
      String partName) throws MetaException {
    try {
      return msc.getPartitionsByNames(getDefaultCatalog(conf), dbName, tableName,
