...
public class HiveSubQRemoveRelBuilder {
  ...
  public HiveSubQRemoveRelBuilder project(
    ...
    final RelNode project =
        projectFactory.createProject(build(), ImmutableList.of(),
            ImmutableList.copyOf(exprList), names);
    push(project);
    return this;
  }
  ...
  public HiveSubQRemoveRelBuilder aggregate(GroupKey groupKey, Iterable<AggCall> aggCalls) {
    ...
    RelNode aggregate = aggregateFactory.createAggregate(r, ImmutableList.of(),
