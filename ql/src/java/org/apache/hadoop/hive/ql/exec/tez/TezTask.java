...
public class TezTask extends Task<TezWork> {
  ...
  public int execute() {
    ...
    try {
      ...
      boolean isLlap = "llap".equalsIgnoreCase(executionMode);
      ...
      try {
        ...
        boolean emitTezSessionWaitMetric = conf.getBoolVar(
            HiveConf.ConfVars.HIVE_SERVER2_EMIT_TEZ_SESSION_WAIT_METRICS);
