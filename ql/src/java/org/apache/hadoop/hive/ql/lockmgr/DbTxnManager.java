...
public final class DbTxnManager extends HiveTxnManagerImpl {
  ...
  /**
   * The local cache of tables with registered minOpen write ID seen by the current transaction
   */
  private Set<String> minOpenTableWriteIds = new HashSet<>();
