...
public class NativeEngineQueryHelper implements EngineQueryHelper {

  public NativeEngineQueryHelper(HiveConf conf, String dbname, String username, HiveTxnManager txnMgr,
  ...
  public FunctionHelper createFunctionHelper(RexBuilder rexBuilder) {
    return new HiveFunctionHelper(rexBuilder);
  }
}
