...
public class CreateViewAnalyzer extends AbstractCreateViewAnalyzer {
  ...
  public void analyzeInternal(ASTNode root) throws SemanticException {
    ...
    ASTNode storageClause = children.remove(HiveParser.TOK_STORAGEHANDLER);
    if (storageClause == null) {
      storageClause = children.remove(HiveParser.TOK_TABLEFILEFORMAT);
    }
    if (storageClause == null) {
      storageClause = children.remove(HiveParser.TOK_FILEFORMAT_GENERIC);
    }
