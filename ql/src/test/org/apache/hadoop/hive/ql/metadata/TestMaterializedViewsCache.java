 ...
 */
public class TestMaterializedViewsCache {
  ...
  public void testEmptyCache() {
    ...
    assertThat(emptyCache.get(any).isEmpty(), is(true));    assertThat(emptyCache.isEmpty(), is(true));
    assertThat(emptyCache.values().isEmpty(), is(true));
  }

  @Test
  public void testGetByTableNameFromEmptyCache() {
    MaterializedViewsCache emptyCache = new MaterializedViewsCache();
  ...
  @Test
  public void testQueryDoesNotMatchAnyMVDefinition() {
  ...
  @Test
  public void testAddSameMVTwice() {
    materializedViewsCache.putIfAbsent(defaultMV1, defaultMaterialization1);
    materializedViewsCache.putIfAbsent(defaultMV1, defaultMaterialization1);
  ...
  @Test
  public void testAddMVsWithSameDefinition() {
    materializedViewsCache.putIfAbsent(defaultMV1, defaultMaterialization1);
  ...
  @Test
  public void testAddMVsWithSameDefinitionButDifferentDatabase() {
    materializedViewsCache.putIfAbsent(defaultMV1, defaultMaterialization1);
  ...
  @Test
  public void testLookupByTextIsCaseSensitive() {
    materializedViewsCache.putIfAbsent(defaultMV1, defaultMaterialization1);
  ...
  @Test
  public void testRefreshWhenMVWasNotCached() {
  ...
  @Test
  public void testRefreshWhenMVIsCachedButWasUpdated() throws ParseException {
    materializedViewsCache.putIfAbsent(defaultMV1, defaultMaterialization1);
  ...
  @Test
  public void testRefreshWhenMVRefersToANewMaterialization() {
    materializedViewsCache.putIfAbsent(defaultMV1, defaultMaterialization1);
  ...
  @Test
  public void testRemoveByTableName() {
    materializedViewsCache.putIfAbsent(defaultMV1, defaultMaterialization1);
  ...
  @Ignore("Testing parallelism only")
  @Test
  public void testParallelism() throws ParseException {
  ...
  private static class DummyRel implements RelNode {
    ...
    public DummyRel(Table table) {
      this.dummyTable = new RelOptHiveTable(null, null,
              ...
              null, null, null, RelOptHiveTable.TableType.NATIVE, null);
    }
