...
public class TestCompactorMRJobQueueConfiguration {
  ...
  public void testCreateBaseJobConfHasCorrectJobQueue() {
    ...
    assertEquals("Test failed for the following input:" + input, input.expectedQueue, c.getQueueName());
  }

  @Parameterized.Parameters
  public static Collection<Object[]> generateBaseJobConfSetup() {
    ...
    return inputs.stream().map(setup -> new Object[] { setup }).collect(Collectors.toList());
  }
