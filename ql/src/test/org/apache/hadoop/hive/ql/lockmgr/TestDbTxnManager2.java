...
public class TestDbTxnManager2 extends DbTxnManagerEndToEndTestBase {
   ...
   * TxnHandler.setConf and TxnHandler.checkQFileTestHack and TestTxnDbUtil.setConfValues, which will
  ...
  public void testMergeMultipleBranchesOptimistic() throws Exception {
    ...
    try {
      ...
      Assert.assertTrue(ex.getException() instanceof LockException);
