...
public class TestTablesGetExists extends MetaStoreClientTest {
  ...
  public void testGetTableObjectsWithIncludePattern() throws Exception {
    ...
    try {
      client.getTables(null, DEFAULT_DATABASE, tableNames, projectSpec);
      Assert.fail("setExcludeParamKeyPattern is not supported and an exception is not thrown");
  ...
  public void testGetTableObjectsWithNonExistentColumn() throws Exception {
    ...
    try {
      client.getTables(null, DEFAULT_DATABASE, tableNames, projectSpec);
      Assert.fail("An invalid table name is passed an exception is not thrown");
    } catch(Exception exception) {
  ...
  public void testGetTableObjectsWithNonExistentColumns() throws Exception {
    ...
    try {
      client.getTables(null, DEFAULT_DATABASE, tableNames, projectSpec);
      Assert.fail("Invalid table names are passed an exception is not thrown");
    } catch (Exception exception) {
