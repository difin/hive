...
import static org.apache.hadoop.hive.metastore.utils.MetaStoreUtils.convertDateToString;
import static org.apache.hadoop.hive.metastore.utils.MetaStoreUtils.convertStringToDate;
import static org.apache.hadoop.hive.metastore.utils.MetaStoreUtils.convertStringToTimestamp;
import static org.apache.hadoop.hive.metastore.utils.MetaStoreUtils.convertTimestampToString;
import static org.junit.Assert.assertEquals;

@RunWith(Parameterized.class)
@Category(MetastoreUnitTest.class)
public class TestMetaStoreUtilsConvert {
  ...
  public void testDateToString() {
    assertEquals(date, convertDateToString(Date.valueOf(date)));
  }
  ...
  public void testStringToDate() {
    assertEquals(Date.valueOf(date), convertStringToDate(date));
  }
