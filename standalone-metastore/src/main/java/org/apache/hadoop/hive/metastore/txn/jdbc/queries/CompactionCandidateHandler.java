...
public class CompactionCandidateHandler implements QueryHandler<Set<CompactionInfo>> {
  ...
  public String getParameterizedQueryString(DatabaseProduct databaseProduct) throws MetaException {
    return sqlGenerator.addLimitClause(fetchSize, 
        ...
        "LEFT JOIN ( " +
            ...
            "WHERE \"C\".\"CC_ID\" IS NOT NULL OR " + sqlGenerator.isWithinCheckInterval("\"TC\".\"CTC_TIMESTAMP\"", checkInterval) : ""));
  }
  ...
  public CompactionCandidateHandler(SQLGenerator sqlGenerator, long lastChecked, int fetchSize) {
