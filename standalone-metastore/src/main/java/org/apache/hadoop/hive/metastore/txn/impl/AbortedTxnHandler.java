...
public class AbortedTxnHandler implements QueryHandler<Set<CompactionInfo>> {
  ...
  public String getParameterizedQueryString(DatabaseProduct databaseProduct) throws MetaException {
    return sqlGenerator.addLimitClause(fetchSize, " \"TC_DATABASE\", \"TC_TABLE\", \"TC_PARTITION\", " +
  ...
  public AbortedTxnHandler(SQLGenerator sqlGenerator, long abortedTimeThreshold, int abortedThreshold, int fetchSize) {
