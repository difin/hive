 ...
 */
    ...
    */
    ...
    private List<Partition> get_partitions_by_filter_internal(final String catName, final String dbName, final String tblName,
                                                    final String filter, final short maxParts, boolean skipColSchemaForPartitions)
            throws TException {
