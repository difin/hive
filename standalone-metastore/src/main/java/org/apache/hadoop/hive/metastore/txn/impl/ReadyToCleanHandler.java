...
public class ReadyToCleanHandler implements QueryHandler<List<CompactionInfo>> {
  ...
  public ReadyToCleanHandler(SQLGenerator sqlGenerator, Configuration conf, boolean useMinHistoryWriteId, 
                             long minOpenTxnWaterMark, long retentionTime) {
  ...
  public String getParameterizedQueryString(DatabaseProduct databaseProduct) throws MetaException {
    ...
    queryStr = sqlGenerator.addLimitClause(fetchSize, queryStr);
    return queryStr;
  }
