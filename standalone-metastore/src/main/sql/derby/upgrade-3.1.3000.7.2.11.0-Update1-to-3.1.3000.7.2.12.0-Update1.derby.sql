...
UPDATE "APP".CDH_VERSION SET SCHEMA_VERSION='3.1.3000.7.2.12.0-Update1', VERSION_COMMENT='Hive release version 3.1.3000 for CDH 7.2.12.0-Update1' where VER_ID=1;
