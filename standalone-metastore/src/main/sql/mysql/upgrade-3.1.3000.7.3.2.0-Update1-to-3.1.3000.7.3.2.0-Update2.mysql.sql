...
ALTER TABLE `COLUMNS_V2` MODIFY COLUMN `COMMENT` varchar(4000) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL, ALGORITHM=INPLACE, LOCK=NONE;
...
SELECT 'Finished upgrading MetaStore schema from 3.1.3000.7.3.2.0-Update1 to 3.1.3000.7.3.2.0-Update2';
