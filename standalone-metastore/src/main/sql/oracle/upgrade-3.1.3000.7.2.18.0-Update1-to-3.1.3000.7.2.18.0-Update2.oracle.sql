SELECT 'Upgrading MetaStore schema from 3.1.3000.7.2.18.0-Update1 to 3.1.3000.7.2.18.0-Update2' AS Status from dual;
...
SELECT 'Finished upgrading MetaStore schema from 3.1.3000.7.2.18.0-Update1 to 3.1.3000.7.2.18.0-Update2' AS Status from dual;
