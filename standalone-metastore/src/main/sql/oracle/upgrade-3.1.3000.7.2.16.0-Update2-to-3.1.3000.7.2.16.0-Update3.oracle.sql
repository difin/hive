SELECT 'Upgrading MetaStore schema from 3.1.3000.7.2.16.0-Update2 to 3.1.3000.7.2.16.0-Update3' AS Status FROM dual;
...
SELECT 'Finished upgrading MetaStore schema from 3.1.3000.7.2.16.0-Update2 to 3.1.3000.7.2.16.0-Update3' AS Status FROM dual;