...
class CreateTableRequest
{
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1074 = 0; $_i1074 < $_size1070; ++$_i1074) {
                            $elem1075 = null;
                            $elem1075 = new \metastore\SQLPrimaryKey();
                            $xfer += $elem1075->read($input);
                            $this->primaryKeys []= $elem1075;
                        }
                ...
                case 4:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1080 = 0; $_i1080 < $_size1076; ++$_i1080) {
                            $elem1081 = null;
                            $elem1081 = new \metastore\SQLForeignKey();
                            $xfer += $elem1081->read($input);
                            $this->foreignKeys []= $elem1081;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
                ...
                case 5:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1086 = 0; $_i1086 < $_size1082; ++$_i1086) {
                            $elem1087 = null;
                            $elem1087 = new \metastore\SQLUniqueConstraint();
                            $xfer += $elem1087->read($input);
                            $this->uniqueConstraints []= $elem1087;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
                ...
                case 6:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1092 = 0; $_i1092 < $_size1088; ++$_i1092) {
                            $elem1093 = null;
                            $elem1093 = new \metastore\SQLNotNullConstraint();
                            $xfer += $elem1093->read($input);
                            $this->notNullConstraints []= $elem1093;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
                ...
                case 7:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1098 = 0; $_i1098 < $_size1094; ++$_i1098) {
                            $elem1099 = null;
                            $elem1099 = new \metastore\SQLDefaultConstraint();
                            $xfer += $elem1099->read($input);
                            $this->defaultConstraints []= $elem1099;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
                ...
                case 8:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1104 = 0; $_i1104 < $_size1100; ++$_i1104) {
                            $elem1105 = null;
                            $elem1105 = new \metastore\SQLCheckConstraint();
                            $xfer += $elem1105->read($input);
                            $this->checkConstraints []= $elem1105;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
                ...
                case 9:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i1110 = 0; $_i1110 < $_size1106; ++$_i1110) {
                            ...
                            $this->processorCapabilities []= $elem1111;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->primaryKeys !== null) {
            ...
            foreach ($this->primaryKeys as $iter1112) {
        ...
        if ($this->foreignKeys !== null) {
            ...
            foreach ($this->foreignKeys as $iter1113) {
        ...
        if ($this->uniqueConstraints !== null) {
            ...
            foreach ($this->uniqueConstraints as $iter1114) {
        ...
        if ($this->notNullConstraints !== null) {
            ...
            foreach ($this->notNullConstraints as $iter1115) {
        ...
        if ($this->defaultConstraints !== null) {
            ...
            foreach ($this->defaultConstraints as $iter1116) {
        ...
        if ($this->checkConstraints !== null) {
            ...
            foreach ($this->checkConstraints as $iter1117) {
        ...
        if ($this->processorCapabilities !== null) {
            ...
            foreach ($this->processorCapabilities as $iter1118) {
