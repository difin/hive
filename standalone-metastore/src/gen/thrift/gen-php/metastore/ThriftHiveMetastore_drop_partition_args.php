...
>>>>>>> 69db3986099 (CDPD-84193: HIVE-28146: Add positive event type filter to the HMS notification fe… (#5694) (Sai Hemanth Gantasala, Reviewed by Zhihua Deng) (#1529))
                        $_size1563 = 0;
                        $_etype1566 = 0;
                        $xfer += $input->readListBegin($_etype1566, $_size1563);
                        for ($_i1567 = 0; $_i1567 < $_size1563; ++$_i1567) {
                            $elem1568 = null;
                            $xfer += $input->readString($elem1568);
                            $this->part_vals []= $elem1568;
<<<<<<< HEAD
=======
                        $_size1556 = 0;
                        $_etype1559 = 0;
                        $xfer += $input->readListBegin($_etype1559, $_size1556);
                        for ($_i1560 = 0; $_i1560 < $_size1556; ++$_i1560) {
                            $elem1561 = null;
                            $xfer += $input->readString($elem1561);
                            $this->part_vals []= $elem1561;
...
<<<<<<< HEAD
<<<<<<< HEAD
            foreach ($this->part_vals as $iter1569) {
                $xfer += $output->writeString($iter1569);
=======
            foreach ($this->part_vals as $iter1562) {
                $xfer += $output->writeString($iter1562);
>>>>>>> 36509d7056c (CDPD-81032: HIVE-28921: Add API and implementation for retrieving database object (#1025))
=======
            foreach ($this->part_vals as $iter1569) {
                $xfer += $output->writeString($iter1569);
