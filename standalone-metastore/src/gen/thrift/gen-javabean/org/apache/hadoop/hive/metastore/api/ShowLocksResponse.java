...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class ShowLocksResponse implements org.apache.thrift.TBase<ShowLocksResponse, ShowLocksResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ShowLocksResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.locks = new java.util.ArrayList<ShowLocksResponseElement>(_list838.size);
                @org.apache.thrift.annotation.Nullable ShowLocksResponseElement _elem839;
                for (int _i840 = 0; _i840 < _list838.size; ++_i840)
                {
                  _elem839 = new ShowLocksResponseElement();
                  _elem839.read(iprot);
                  struct.locks.add(_elem839);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ShowLocksResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.locks != null) {
        oprot.writeFieldBegin(LOCKS_FIELD_DESC);
        {
          ...
          for (ShowLocksResponseElement _iter841 : struct.locks)
          {
  ...
  private static class ShowLocksResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<ShowLocksResponse> {
      ...
      if (struct.isSetLocks()) {
        {
          ...
          for (ShowLocksResponseElement _iter842 : struct.locks)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ShowLocksResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list843 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.locks = new java.util.ArrayList<ShowLocksResponseElement>(_list843.size);
          @org.apache.thrift.annotation.Nullable ShowLocksResponseElement _elem844;
          for (int _i845 = 0; _i845 < _list843.size; ++_i845)
          {
            _elem844 = new ShowLocksResponseElement();
            _elem844.read(iprot);
            struct.locks.add(_elem844);
          }
        }
        struct.setLocksIsSet(true);
      }
