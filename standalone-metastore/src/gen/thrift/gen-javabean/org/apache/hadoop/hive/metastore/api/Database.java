            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new HashMap<String,String>(2*_map168.size);
                String _key169;
                String _val170;
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (Map.Entry<String, String> _iter173 : struct.parameters.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.parameters = new HashMap<String,String>(2*_map174.size);
          String _key175;
          String _val176;
