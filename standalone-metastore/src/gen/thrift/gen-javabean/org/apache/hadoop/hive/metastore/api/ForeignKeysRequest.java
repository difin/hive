...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class ForeignKeysRequest implements org.apache.thrift.TBase<ForeignKeysRequest, ForeignKeysRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ForeignKeysRequest> {
  ...
  public int compareTo(ForeignKeysRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetParent_db_name()).compareTo(other.isSetParent_db_name());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetParent_tbl_name()).compareTo(other.isSetParent_tbl_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetParent_tbl_name()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetForeign_db_name()).compareTo(other.isSetForeign_db_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetForeign_db_name()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetForeign_tbl_name()).compareTo(other.isSetForeign_tbl_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetForeign_tbl_name()) {
