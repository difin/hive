            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requiredReadCapabilities = new ArrayList<String>(_list1074.size);
                String _elem1075;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requiredWriteCapabilities = new ArrayList<String>(_list1077.size);
                String _elem1078;
      ...
      if (struct.requiredReadCapabilities != null) {
        if (struct.isSetRequiredReadCapabilities()) {
          oprot.writeFieldBegin(REQUIRED_READ_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (String _iter1080 : struct.requiredReadCapabilities)
            {
      ...
      if (struct.requiredWriteCapabilities != null) {
        if (struct.isSetRequiredWriteCapabilities()) {
          oprot.writeFieldBegin(REQUIRED_WRITE_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (String _iter1081 : struct.requiredWriteCapabilities)
            {
      ...
      if (struct.isSetRequiredReadCapabilities()) {
        {
          ...
          for (String _iter1082 : struct.requiredReadCapabilities)
          {
      ...
      if (struct.isSetRequiredWriteCapabilities()) {
        {
          ...
          for (String _iter1083 : struct.requiredWriteCapabilities)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.requiredReadCapabilities = new ArrayList<String>(_list1084.size);
          String _elem1085;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.requiredWriteCapabilities = new ArrayList<String>(_list1087.size);
          String _elem1088;
