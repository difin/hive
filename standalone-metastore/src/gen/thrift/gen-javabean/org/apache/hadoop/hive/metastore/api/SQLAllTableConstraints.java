...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class SQLAllTableConstraints implements org.apache.thrift.TBase<SQLAllTableConstraints, SQLAllTableConstraints._Fields>, java.io.Serializable, Cloneable, Comparable<SQLAllTableConstraints> {
  ...
  static {
    schemes.put(StandardScheme.class, new SQLAllTableConstraintsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SQLAllTableConstraintsTupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SQLAllTableConstraints(");
    boolean first = true;
  ...
  private static class SQLAllTableConstraintsStandardSchemeFactory implements SchemeFactory {
    public SQLAllTableConstraintsStandardScheme getScheme() {
      return new SQLAllTableConstraintsStandardScheme();
    }
  }

  private static class SQLAllTableConstraintsStandardScheme extends StandardScheme<SQLAllTableConstraints> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.primaryKeys = new ArrayList<SQLPrimaryKey>(_list10.size);
                SQLPrimaryKey _elem11;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.foreignKeys = new ArrayList<SQLForeignKey>(_list13.size);
                SQLForeignKey _elem14;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uniqueConstraints = new ArrayList<SQLUniqueConstraint>(_list16.size);
                SQLUniqueConstraint _elem17;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.notNullConstraints = new ArrayList<SQLNotNullConstraint>(_list19.size);
                SQLNotNullConstraint _elem20;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.defaultConstraints = new ArrayList<SQLDefaultConstraint>(_list22.size);
                SQLDefaultConstraint _elem23;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.checkConstraints = new ArrayList<SQLCheckConstraint>(_list25.size);
                SQLCheckConstraint _elem26;
  ...
  private static class SQLAllTableConstraintsTupleSchemeFactory implements SchemeFactory {
    public SQLAllTableConstraintsTupleScheme getScheme() {
      return new SQLAllTableConstraintsTupleScheme();
    }
  }

  private static class SQLAllTableConstraintsTupleScheme extends TupleScheme<SQLAllTableConstraints> {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.primaryKeys = new ArrayList<SQLPrimaryKey>(_list40.size);
          SQLPrimaryKey _elem41;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.foreignKeys = new ArrayList<SQLForeignKey>(_list43.size);
          SQLForeignKey _elem44;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.uniqueConstraints = new ArrayList<SQLUniqueConstraint>(_list46.size);
          SQLUniqueConstraint _elem47;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.notNullConstraints = new ArrayList<SQLNotNullConstraint>(_list49.size);
          SQLNotNullConstraint _elem50;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.defaultConstraints = new ArrayList<SQLDefaultConstraint>(_list52.size);
          SQLDefaultConstraint _elem53;
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.checkConstraints = new ArrayList<SQLCheckConstraint>(_list55.size);
          SQLCheckConstraint _elem56;
