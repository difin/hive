            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.names = new ArrayList<String>(_list160.size);
                String _elem161;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetCatalogsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.names != null) {
        oprot.writeFieldBegin(NAMES_FIELD_DESC);
        {
          ...
          for (String _iter163 : struct.names)
          {
      ...
      if (struct.isSetNames()) {
        {
          ...
          for (String _iter164 : struct.names)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.names = new ArrayList<String>(_list165.size);
          String _elem166;
