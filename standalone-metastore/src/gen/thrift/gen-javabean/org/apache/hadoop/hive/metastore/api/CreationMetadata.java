...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class CreationMetadata implements org.apache.thrift.TBase<CreationMetadata, CreationMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<CreationMetadata> {
  ...
  public int compareTo(CreationMetadata other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTablesUsed()).compareTo(other.isSetTablesUsed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTablesUsed()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMaterializationTime()).compareTo(other.isSetMaterializationTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMaterializationTime()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSourceTables()).compareTo(other.isSetSourceTables());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSourceTables()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sourceTables = new java.util.ArrayList<SourceTable>(_list267.size);
  ...
  private static class CreationMetadataTupleScheme extends org.apache.thrift.scheme.TupleScheme<CreationMetadata> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CreationMetadata struct) throws org.apache.thrift.TException {
      ...
      struct.setTblNameIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set274 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.sourceTables = new java.util.ArrayList<SourceTable>(_list277.size);
