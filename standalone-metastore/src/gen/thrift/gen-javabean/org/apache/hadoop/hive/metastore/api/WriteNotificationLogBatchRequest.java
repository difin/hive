            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requestList = new java.util.ArrayList<WriteNotificationLogRequest>(_list1010.size);
                @org.apache.thrift.annotation.Nullable WriteNotificationLogRequest _elem1011;
                for (int _i1012 = 0; _i1012 < _list1010.size; ++_i1012)
                {
                  _elem1011 = new WriteNotificationLogRequest();
                  _elem1011.read(iprot);
                  struct.requestList.add(_elem1011);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WriteNotificationLogBatchRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.requestList != null) {
        oprot.writeFieldBegin(REQUEST_LIST_FIELD_DESC);
        {
          ...
          for (WriteNotificationLogRequest _iter1013 : struct.requestList)
          {
  ...
  private static class WriteNotificationLogBatchRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<WriteNotificationLogBatchRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, WriteNotificationLogBatchRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.table);
      {
        ...
        for (WriteNotificationLogRequest _iter1014 : struct.requestList)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WriteNotificationLogBatchRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTableIsSet(true);
      {
        ...
        struct.requestList = new java.util.ArrayList<WriteNotificationLogRequest>(_list1015.size);
        @org.apache.thrift.annotation.Nullable WriteNotificationLogRequest _elem1016;
        for (int _i1017 = 0; _i1017 < _list1015.size; ++_i1017)
        {
          _elem1016 = new WriteNotificationLogRequest();
          _elem1016.read(iprot);
          struct.requestList.add(_elem1016);
        }
      }
      struct.setRequestListIsSet(true);
    }
