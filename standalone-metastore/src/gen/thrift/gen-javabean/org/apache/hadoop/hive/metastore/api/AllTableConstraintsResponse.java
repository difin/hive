...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class AllTableConstraintsResponse implements org.apache.thrift.TBase<AllTableConstraintsResponse, AllTableConstraintsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<AllTableConstraintsResponse> {
  ...
  static {
    schemes.put(StandardScheme.class, new AllTableConstraintsResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AllTableConstraintsResponseTupleSchemeFactory());
  }

  private SQLAllTableConstraints allTableConstraints; // required
  ...
  public int hashCode() {
    ...
    boolean present_allTableConstraints = true && (isSetAllTableConstraints());
    list.add(present_allTableConstraints);
    if (present_allTableConstraints)
      list.add(allTableConstraints);
  ...
  public int compareTo(AllTableConstraintsResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetAllTableConstraints()).compareTo(other.isSetAllTableConstraints());
    if (lastComparison != 0) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AllTableConstraintsResponse(");
    boolean first = true;
  ...
  private static class AllTableConstraintsResponseStandardSchemeFactory implements SchemeFactory {
    public AllTableConstraintsResponseStandardScheme getScheme() {
      return new AllTableConstraintsResponseStandardScheme();
    }
  }

  private static class AllTableConstraintsResponseStandardScheme extends StandardScheme<AllTableConstraintsResponse> {
  ...
  private static class AllTableConstraintsResponseTupleSchemeFactory implements SchemeFactory {
    public AllTableConstraintsResponseTupleScheme getScheme() {
      return new AllTableConstraintsResponseTupleScheme();
    }
  }

  private static class AllTableConstraintsResponseTupleScheme extends TupleScheme<AllTableConstraintsResponse> {
