            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new java.util.ArrayList<WMPool>(_list1174.size);
                @org.apache.thrift.annotation.Nullable WMPool _elem1175;
                for (int _i1176 = 0; _i1176 < _list1174.size; ++_i1176)
                {
                  _elem1175 = new WMPool();
                  _elem1175.read(iprot);
                  struct.pools.add(_elem1175);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mappings = new java.util.ArrayList<WMMapping>(_list1177.size);
                @org.apache.thrift.annotation.Nullable WMMapping _elem1178;
                for (int _i1179 = 0; _i1179 < _list1177.size; ++_i1179)
                {
                  _elem1178 = new WMMapping();
                  _elem1178.read(iprot);
                  struct.mappings.add(_elem1178);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.poolTriggers = new java.util.ArrayList<WMPoolTrigger>(_list1183.size);
                @org.apache.thrift.annotation.Nullable WMPoolTrigger _elem1184;
                for (int _i1185 = 0; _i1185 < _list1183.size; ++_i1185)
                {
                  _elem1184 = new WMPoolTrigger();
                  _elem1184.read(iprot);
                  struct.poolTriggers.add(_elem1184);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      if (struct.pools != null) {
        oprot.writeFieldBegin(POOLS_FIELD_DESC);
        {
          ...
          for (WMPool _iter1186 : struct.pools)
          {
      ...
      if (struct.mappings != null) {
        if (struct.isSetMappings()) {
          oprot.writeFieldBegin(MAPPINGS_FIELD_DESC);
          {
            ...
            for (WMMapping _iter1187 : struct.mappings)
            {
      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          oprot.writeFieldBegin(TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMTrigger _iter1188 : struct.triggers)
            {
      ...
      if (struct.poolTriggers != null) {
        if (struct.isSetPoolTriggers()) {
          oprot.writeFieldBegin(POOL_TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMPoolTrigger _iter1189 : struct.poolTriggers)
            {
  ...
  private static class WMFullResourcePlanTupleScheme extends org.apache.thrift.scheme.TupleScheme<WMFullResourcePlan> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      struct.plan.write(oprot);
      {
        ...
        for (WMPool _iter1190 : struct.pools)
        {
      ...
      if (struct.isSetMappings()) {
        {
          ...
          for (WMMapping _iter1191 : struct.mappings)
          {
      ...
      if (struct.isSetPoolTriggers()) {
        {
          ...
          for (WMPoolTrigger _iter1193 : struct.poolTriggers)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      struct.setPlanIsSet(true);
      {
        org.apache.thrift.protocol.TList _list1194 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.pools = new java.util.ArrayList<WMPool>(_list1194.size);
        @org.apache.thrift.annotation.Nullable WMPool _elem1195;
        for (int _i1196 = 0; _i1196 < _list1194.size; ++_i1196)
        {
          _elem1195 = new WMPool();
          _elem1195.read(iprot);
          struct.pools.add(_elem1195);
        }
      }
      struct.setPoolsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.mappings = new java.util.ArrayList<WMMapping>(_list1197.size);
          @org.apache.thrift.annotation.Nullable WMMapping _elem1198;
          for (int _i1199 = 0; _i1199 < _list1197.size; ++_i1199)
          {
            _elem1198 = new WMMapping();
            _elem1198.read(iprot);
            struct.mappings.add(_elem1198);
          }
        }
        struct.setMappingsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list1200 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.triggers = new java.util.ArrayList<WMTrigger>(_list1200.size);
          @org.apache.thrift.annotation.Nullable WMTrigger _elem1201;
          for (int _i1202 = 0; _i1202 < _list1200.size; ++_i1202)
          {
            _elem1201 = new WMTrigger();
            _elem1201.read(iprot);
            struct.triggers.add(_elem1201);
          }
        }
        struct.setTriggersIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.poolTriggers = new java.util.ArrayList<WMPoolTrigger>(_list1203.size);
          @org.apache.thrift.annotation.Nullable WMPoolTrigger _elem1204;
          for (int _i1205 = 0; _i1205 < _list1203.size; ++_i1205)
          {
            _elem1204 = new WMPoolTrigger();
            _elem1204.read(iprot);
            struct.poolTriggers.add(_elem1204);
          }
        }
        struct.setPoolTriggersIsSet(true);
      }
