            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new java.util.ArrayList<WMPool>(_list1182.size);
                @org.apache.thrift.annotation.Nullable WMPool _elem1183;
                for (int _i1184 = 0; _i1184 < _list1182.size; ++_i1184)
                {
                  _elem1183 = new WMPool();
                  _elem1183.read(iprot);
                  struct.pools.add(_elem1183);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mappings = new java.util.ArrayList<WMMapping>(_list1185.size);
                @org.apache.thrift.annotation.Nullable WMMapping _elem1186;
                for (int _i1187 = 0; _i1187 < _list1185.size; ++_i1187)
                {
                  _elem1186 = new WMMapping();
                  _elem1186.read(iprot);
                  struct.mappings.add(_elem1186);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.poolTriggers = new java.util.ArrayList<WMPoolTrigger>(_list1191.size);
                @org.apache.thrift.annotation.Nullable WMPoolTrigger _elem1192;
                for (int _i1193 = 0; _i1193 < _list1191.size; ++_i1193)
                {
                  _elem1192 = new WMPoolTrigger();
                  _elem1192.read(iprot);
                  struct.poolTriggers.add(_elem1192);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      if (struct.pools != null) {
        oprot.writeFieldBegin(POOLS_FIELD_DESC);
        {
          ...
          for (WMPool _iter1194 : struct.pools)
          {
      ...
      if (struct.mappings != null) {
        if (struct.isSetMappings()) {
          oprot.writeFieldBegin(MAPPINGS_FIELD_DESC);
          {
            ...
            for (WMMapping _iter1195 : struct.mappings)
            {
      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          oprot.writeFieldBegin(TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMTrigger _iter1196 : struct.triggers)
            {
      ...
      if (struct.poolTriggers != null) {
        if (struct.isSetPoolTriggers()) {
          oprot.writeFieldBegin(POOL_TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMPoolTrigger _iter1197 : struct.poolTriggers)
            {
  ...
  private static class WMFullResourcePlanTupleScheme extends org.apache.thrift.scheme.TupleScheme<WMFullResourcePlan> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      struct.plan.write(oprot);
      {
        ...
        for (WMPool _iter1198 : struct.pools)
        {
      ...
      if (struct.isSetMappings()) {
        {
          ...
          for (WMMapping _iter1199 : struct.mappings)
          {
      ...
      if (struct.isSetTriggers()) {
        {
          ...
          for (WMTrigger _iter1200 : struct.triggers)
          {
      ...
      if (struct.isSetPoolTriggers()) {
        {
          ...
          for (WMPoolTrigger _iter1201 : struct.poolTriggers)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WMFullResourcePlan struct) throws org.apache.thrift.TException {
      ...
      struct.setPlanIsSet(true);
      {
        org.apache.thrift.protocol.TList _list1202 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.pools = new java.util.ArrayList<WMPool>(_list1202.size);
        @org.apache.thrift.annotation.Nullable WMPool _elem1203;
        for (int _i1204 = 0; _i1204 < _list1202.size; ++_i1204)
        {
          _elem1203 = new WMPool();
          _elem1203.read(iprot);
          struct.pools.add(_elem1203);
        }
      }
      struct.setPoolsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list1205 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.mappings = new java.util.ArrayList<WMMapping>(_list1205.size);
          @org.apache.thrift.annotation.Nullable WMMapping _elem1206;
          for (int _i1207 = 0; _i1207 < _list1205.size; ++_i1207)
          {
            _elem1206 = new WMMapping();
            _elem1206.read(iprot);
            struct.mappings.add(_elem1206);
          }
        }
        struct.setMappingsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.triggers = new java.util.ArrayList<WMTrigger>(_list1208.size);
          @org.apache.thrift.annotation.Nullable WMTrigger _elem1209;
          for (int _i1210 = 0; _i1210 < _list1208.size; ++_i1210)
          {
            _elem1209 = new WMTrigger();
            _elem1209.read(iprot);
            struct.triggers.add(_elem1209);
          }
        }
        struct.setTriggersIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.poolTriggers = new java.util.ArrayList<WMPoolTrigger>(_list1211.size);
          @org.apache.thrift.annotation.Nullable WMPoolTrigger _elem1212;
          for (int _i1213 = 0; _i1213 < _list1211.size; ++_i1213)
          {
            _elem1212 = new WMPoolTrigger();
            _elem1212.read(iprot);
            struct.poolTriggers.add(_elem1212);
          }
        }
        struct.setPoolTriggersIsSet(true);
      }
