            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.triggers = new java.util.ArrayList<WMTrigger>(_list1222.size);
                @org.apache.thrift.annotation.Nullable WMTrigger _elem1223;
                for (int _i1224 = 0; _i1224 < _list1222.size; ++_i1224)
                {
                  _elem1223 = new WMTrigger();
                  _elem1223.read(iprot);
                  struct.triggers.add(_elem1223);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          oprot.writeFieldBegin(TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMTrigger _iter1225 : struct.triggers)
            {
      ...
      if (struct.isSetTriggers()) {
        {
          ...
          for (WMTrigger _iter1226 : struct.triggers)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.triggers = new java.util.ArrayList<WMTrigger>(_list1227.size);
          @org.apache.thrift.annotation.Nullable WMTrigger _elem1228;
          for (int _i1229 = 0; _i1229 < _list1227.size; ++_i1229)
          {
            _elem1228 = new WMTrigger();
            _elem1228.read(iprot);
            struct.triggers.add(_elem1228);
          }
        }
        struct.setTriggersIsSet(true);
      }
