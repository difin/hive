            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.triggers = new java.util.ArrayList<WMTrigger>(_list1182.size);
                @org.apache.thrift.annotation.Nullable WMTrigger _elem1183;
                for (int _i1184 = 0; _i1184 < _list1182.size; ++_i1184)
                {
                  _elem1183 = new WMTrigger();
                  _elem1183.read(iprot);
                  struct.triggers.add(_elem1183);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          oprot.writeFieldBegin(TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMTrigger _iter1185 : struct.triggers)
            {
      ...
      if (struct.isSetTriggers()) {
        {
          ...
          for (WMTrigger _iter1186 : struct.triggers)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.triggers = new java.util.ArrayList<WMTrigger>(_list1187.size);
          @org.apache.thrift.annotation.Nullable WMTrigger _elem1188;
          for (int _i1189 = 0; _i1189 < _list1187.size; ++_i1189)
          {
            _elem1188 = new WMTrigger();
            _elem1188.read(iprot);
            struct.triggers.add(_elem1188);
          }
        }
        struct.setTriggersIsSet(true);
      }
