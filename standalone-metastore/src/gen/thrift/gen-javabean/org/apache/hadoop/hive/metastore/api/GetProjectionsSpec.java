...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetProjectionsSpec implements org.apache.thrift.TBase<GetProjectionsSpec, GetProjectionsSpec._Fields>, java.io.Serializable, Cloneable, Comparable<GetProjectionsSpec> {
  ...
  static {
    schemes.put(StandardScheme.class, new GetProjectionsSpecStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetProjectionsSpecTupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetProjectionsSpec(");
    boolean first = true;
  ...
  private static class GetProjectionsSpecStandardSchemeFactory implements SchemeFactory {
    public GetProjectionsSpecStandardScheme getScheme() {
      return new GetProjectionsSpecStandardScheme();
    }
  }

  private static class GetProjectionsSpecStandardScheme extends StandardScheme<GetProjectionsSpec> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldList = new ArrayList<String>(_list1026.size);
                String _elem1027;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetProjectionsSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldList != null) {
        oprot.writeFieldBegin(FIELD_LIST_FIELD_DESC);
        {
          ...
          for (String _iter1029 : struct.fieldList)
          {
  ...
  private static class GetProjectionsSpecTupleSchemeFactory implements SchemeFactory {
    public GetProjectionsSpecTupleScheme getScheme() {
      return new GetProjectionsSpecTupleScheme();
    }
  }

  private static class GetProjectionsSpecTupleScheme extends TupleScheme<GetProjectionsSpec> {
      ...
      if (struct.isSetFieldList()) {
        {
          ...
          for (String _iter1030 : struct.fieldList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldList = new ArrayList<String>(_list1031.size);
          String _elem1032;
