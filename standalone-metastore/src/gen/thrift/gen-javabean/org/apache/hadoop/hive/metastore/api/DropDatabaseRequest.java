...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class DropDatabaseRequest implements org.apache.thrift.TBase<DropDatabaseRequest, DropDatabaseRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DropDatabaseRequest> {
  ...
  public int compareTo(DropDatabaseRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIgnoreUnknownDb()).compareTo(other.isSetIgnoreUnknownDb());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCascade()).compareTo(other.isSetCascade());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCascade()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSoftDelete()).compareTo(other.isSetSoftDelete());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSoftDelete()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDeleteManagedDir()).compareTo(other.isSetDeleteManagedDir());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDeleteManagedDir()) {
