...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class SourceTable implements org.apache.thrift.TBase<SourceTable, SourceTable._Fields>, java.io.Serializable, Cloneable, Comparable<SourceTable> {
  ...
  public int compareTo(SourceTable other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInsertedCount()).compareTo(other.isSetInsertedCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetUpdatedCount()).compareTo(other.isSetUpdatedCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDeletedCount()).compareTo(other.isSetDeletedCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
