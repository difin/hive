...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class StorageDescriptor implements org.apache.thrift.TBase<StorageDescriptor, StorageDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<StorageDescriptor> {
  ...
  public int compareTo(StorageDescriptor other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInputFormat()).compareTo(other.isSetInputFormat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInputFormat()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOutputFormat()).compareTo(other.isSetOutputFormat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOutputFormat()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCompressed()).compareTo(other.isSetCompressed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCompressed()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNumBuckets()).compareTo(other.isSetNumBuckets());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumBuckets()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSerdeInfo()).compareTo(other.isSetSerdeInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSerdeInfo()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSortCols()).compareTo(other.isSetSortCols());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSortCols()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSkewedInfo()).compareTo(other.isSetSkewedInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSkewedInfo()) {
