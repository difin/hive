...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class AllTableConstraintsRequest implements org.apache.thrift.TBase<AllTableConstraintsRequest, AllTableConstraintsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AllTableConstraintsRequest> {
  ...
  static {
    schemes.put(StandardScheme.class, new AllTableConstraintsRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AllTableConstraintsRequestTupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AllTableConstraintsRequest(");
    boolean first = true;
  ...
  private static class AllTableConstraintsRequestStandardSchemeFactory implements SchemeFactory {
    public AllTableConstraintsRequestStandardScheme getScheme() {
      return new AllTableConstraintsRequestStandardScheme();
    }
  }

  private static class AllTableConstraintsRequestStandardScheme extends StandardScheme<AllTableConstraintsRequest> {
  ...
  private static class AllTableConstraintsRequestTupleSchemeFactory implements SchemeFactory {
    public AllTableConstraintsRequestTupleScheme getScheme() {
      return new AllTableConstraintsRequestTupleScheme();
    }
  }

  private static class AllTableConstraintsRequestTupleScheme extends TupleScheme<AllTableConstraintsRequest> {
