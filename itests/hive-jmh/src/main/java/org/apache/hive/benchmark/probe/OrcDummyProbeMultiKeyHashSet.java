...
public class OrcDummyProbeMultiKeyHashSet extends OrcProbeHashTable {
  ...
  public OrcDummyProbeMultiKeyHashSet(VectorMapJoinHashTable vTable, VectorMapJoinInfo vInfo) throws HiveException {
    super(vTable, vInfo);
