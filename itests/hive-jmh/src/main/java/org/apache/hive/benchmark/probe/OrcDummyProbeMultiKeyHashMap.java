...
public class OrcDummyProbeMultiKeyHashMap extends OrcProbeHashTable {
  ...
  public OrcDummyProbeMultiKeyHashMap(VectorMapJoinHashTable vTable, VectorMapJoinInfo vInfo) throws HiveException {
    super(vTable, vInfo);
