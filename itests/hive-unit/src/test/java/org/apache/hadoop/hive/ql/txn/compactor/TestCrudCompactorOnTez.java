...
public class TestCrudCompactorOnTez extends CompactorOnTezTest {
  ...
  public void secondCompactionShouldBeRefusedBeforeEnqueueing() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals("FAILED: Execution Error, return code 10432 from org.apache.hadoop.hive.ql.ddl.DDLTask. " +
          "Compaction request for default.compaction_test is refused, details: Compaction is already scheduled with " +
          "state='ready for cleaning' and id=1.", e.getErrorMessage());
