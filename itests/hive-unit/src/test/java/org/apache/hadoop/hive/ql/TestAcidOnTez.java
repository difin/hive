...
public class TestAcidOnTez {
  ...
  public void setUp() throws Exception {
    ...
    hiveConf.set(HiveConf.ConfVars.HIVETEZCONTAINERSIZE.varname, "128");
    hiveConf.setBoolean(HiveConf.ConfVars.HIVEMERGETEZFILES.varname, false);
...
*/
  ...
  public void testGetSplitsLocks() throws Exception {
    ...
    hiveConf.setVar(ConfVars.HIVEFETCHTASKCONVERSION, "more");
